...
console.log(data);
  ...
  const {className,instructorName,email, price, seats} = data;
  const newItem ={className,instructorName,email, price: parseFloat(price), seats: parseFloat(seats),image:imgURL, status:'pending'} 
  console.log(newItem)
    ...
    <div className='w-full px-20'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="form-control w-full">
          ...
          <input type="text" placeholder="Instructor Name" {...register("instructor", { required: true, maxLength: 120 })} className="input input-bordered w-full " />
        </div>
        <div className='flex gap-4 my-4'>
          <div className="form-control w-full">
            ...
            <input type="email" placeholder="Instructors Email" {...register("email", { required: true, maxLength: 120 })} className="input input-bordered w-full " />
          </div>
