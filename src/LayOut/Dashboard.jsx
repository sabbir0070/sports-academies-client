...
import { FaBook, FaBookOpen, FaBookmark, FaCarAlt, FaDollarSign, FaHome, FaRegAddressBook, FaUser, FaUserAlt, FaUserCircle, } from 'react-icons/fa';
        ...
        <ul className="menu p-4 w-80 h-full bg-yellow-600 text-base-content">
          ...
          <div className='divider'></div>
          {
            isAdmin ? <>
              ...
              {/*  */}
              <li> <NavLink to="/dashboard/addClass"> <FaRegAddressBook className='w-6 h-6'></FaRegAddressBook> Add A Class </NavLink> </li>
